...
import {
  Menu, X, LogOut, User,
  Bot, Home, Inbox, Layers, ShieldCheck, SlidersHorizontal, Telescope, Sparkles, PenLine, MessageCircle, Image as ImageIcon, KanbanSquare, Settings, HelpCircle, FileText, Clapperboard, FileBarChart, Share2, Palette, LineChart, Globe,
} from "lucide-react";
